...
public:
    ...
    //     return helper(0,true,2,prices,dp);
    // }
    ...
    //     for(int buy=0;buy<2;buy++)
    //     {
    //         for(int maxtransaction=0;maxtransaction<3;maxtransaction++)
    //         {
    ...
    //         for(int buy=0;buy<2;buy++)
    //         {
    //             for(int maxtransaction=1;maxtransaction<3;maxtransaction++)
    //             {
    //                 if(buy == 1)
    //                 {
